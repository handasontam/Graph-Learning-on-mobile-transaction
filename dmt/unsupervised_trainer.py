...
class UnsupervisedTrainer(object):
    def __init__(self, g, unsupervised_model, encoder, decoder, loss_fn, unsupervised_optimizer, decoder_optimizer, epochs, features, labels, train_mask, val_mask, test_mask, fast_mode, n_edges, patience, num_neighbors, n_layers, num_cpu, cuda_context, model_dir='./'):
        self.g = g
    ...
    def train(self):
        ...
        for epoch in range(self.epochs):
            ...
            if loss < best:
                ...
                best_t = epoch
                cnt_wait = 0
                torch.save(self.unsupervised_model.state_dict(), 'best_unsupervised.pkl')
            else:
                cnt_wait += 1
        ...
        self.unsupervised_model.load_state_dict(torch.load('best_unsupervised.pkl'))
