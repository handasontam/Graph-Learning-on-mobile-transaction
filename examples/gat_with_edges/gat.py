...
class GraphAttention(nn.Module):
    def __init__(self,
        ...
        nn.init.xavier_normal_(self.atten_e.data ,gain=1.414)
...
class GAT(nn.Module):
    def __init__(self,
        ...
        for l in range(1, num_layers):
            ...
            self.gat_layers.append(GraphAttention(
                g, num_hidden * heads[l-1], edge_in_dim, num_hidden, heads[l],
    ...
    def forward(self, inputs, edge_inputs):
        ...
        for l in range(self.num_layers):
            ...
            h = self.activation(h)
        # output projection
        logits = self.gat_layers[-1](h, e).mean(1)
        return logits
